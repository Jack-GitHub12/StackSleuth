...
exports.BrowserExtension = void 0;
const core_1 = require("@stacksleuth/core");
class BrowserExtension extends core_1.BaseAgent {
    constructor(config = {}) {
        super(config);
        this.metrics = [];
    ...
    setupDevToolsPanel() {
        ...
        if (chrome.devtools && chrome.devtools.panels) {
            chrome.devtools.panels.create('StackSleuth', 'icons/icon48.png', 'devtools/panel.html', (panel) => {
    ...
    mapMessageTypeToMetricType(messageType) {
        switch (messageType) {
    ...
    updateTabPerformanceData(tabId, message) {
